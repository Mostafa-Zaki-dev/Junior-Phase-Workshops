...
const find = (id) => {
  // Array.prototype.find method returns the value of the first element in the provided array that satisfies the provided testing function.
  const postObj = data.find((element) => element.id === +id);
